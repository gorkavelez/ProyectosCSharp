...
namespace INIKER.ListaEmpresas
{
    ...
    public partial class ListaEmpresas_Service : System.Web.Services.Protocols.SoapHttpClientProtocol
    {
        ...
        public ListaEmpresas[] ReadMultiple(string Where, int pageSize, int numPage, string Sort)
        {
            bool flagResp = false;
            string lastReadKey = null;
            INIKER.ListaEmpresas.ListaEmpresas_Filter[] filtros = null;            
            //Array.Resize(ref misFiltros, 0);
            ListaEmpresas[] consultaPage; // = new AT_Solicitudes();
        ...
        private bool AplicarFiltros(string Where, ref INIKER.ListaEmpresas.ListaEmpresas_Filter[] misFiltros)
        {
            ...
            try
            {
                INIKER.ListaEmpresas.ListaEmpresas_Filter miFiltro;
                Array.Resize(ref misFiltros, 0);
                ...
                if ((Where != null) && Where.Length > 0)
                {
                    ...
                    {
                        miFiltro = new INIKER.ListaEmpresas.ListaEmpresas_Filter();
                        miFiltro.Field = INIKER.ListaEmpresas.ListaEmpresas_Fields.Name;
