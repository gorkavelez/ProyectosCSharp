...
namespace INIKER.NumerosSerieProduccion
{
    ...
    public partial class InfoNumSerieLeidosEntrada_Service : System.Web.Services.Protocols.SoapHttpClientProtocol
    {
        ...
        public InfoNumSerieLeidosEntrada[] ReadMultiple(string Where, int pageSize, int numPage, string Sort)
        {
            bool flagResp = false;
            string lastReadKey = null;
            INIKER.NumerosSerieProduccion.InfoNumSerieLeidosEntrada_Filter[] filtros = null;            
            //Array.Resize(ref misFiltros, 0);
            InfoNumSerieLeidosEntrada[] consultaPage; // = new AT_Solicitudes();
        ...
        private bool AplicarFiltros(string Where, ref INIKER.NumerosSerieProduccion.InfoNumSerieLeidosEntrada_Filter[] misFiltros)
        {
            ...
            try
            {
                INIKER.NumerosSerieProduccion.InfoNumSerieLeidosEntrada_Filter miFiltro;
                Array.Resize(ref misFiltros, 0);
                ...
                if ((Where != null) && Where.Length > 0)
                {
                    ...
                    {
                        miFiltro = new INIKER.NumerosSerieProduccion.InfoNumSerieLeidosEntrada_Filter();
                        miFiltro.Field = INIKER.NumerosSerieProduccion.InfoNumSerieLeidosEntrada_Fields.Num_pedido;
                    ...
                    //{
                    //    miFiltro = new INIKER.NumerosSerie.InformacionNumSerie_Filter();
                    //    miFiltro.Field = INIKER.NumerosSerie.InformacionNumSerie_Fields.Serial_No;
                    ...
                    //{
                    //    miFiltro = new INIKER.NumerosSerie.InformacionNumSerie_Filter();
                    //    miFiltro.Field = INIKER.NumerosSerie.InformacionNumSerie_Fields.Item_No;
