...
namespace INIKER.Produccion
{
    ...
    public partial class ProduccionINDUSAL_Service : System.Web.Services.Protocols.SoapHttpClientProtocol
    {
        ...
        public ProduccionINDUSAL[] ReadMultiple(string Where, int pageSize, int numPage, string Sort)
        {
            bool flagResp = false;
            string lastReadKey = null;
            INIKER.Produccion.ProduccionINDUSAL_Filter[] filtros = null;            
            //Array.Resize(ref misFiltros, 0);
            ProduccionINDUSAL[] consultaPage; // = new AT_Solicitudes();
        ...
        private bool AplicarFiltros(string Where, ref INIKER.Produccion.ProduccionINDUSAL_Filter[] misFiltros)
        {
            ...
            try
            {
                INIKER.Produccion.ProduccionINDUSAL_Filter miFiltro;
                Array.Resize(ref misFiltros, 0);
                ...
                if ((Where != null) && Where.Length > 0)
                {
                    ...
                    {
                        miFiltro = new INIKER.Produccion.ProduccionINDUSAL_Filter();
                        miFiltro.Field = INIKER.Produccion.ProduccionINDUSAL_Fields.Num_movimiento;
