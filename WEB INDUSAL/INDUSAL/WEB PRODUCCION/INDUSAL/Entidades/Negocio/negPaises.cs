...
namespace INIKER.Paises
{
    ...
    public partial class ListaPaisesINDUSAL_Service : System.Web.Services.Protocols.SoapHttpClientProtocol
    {
        ...
        //INIKER.ATFunciones.AT_Funciones_WS Funciones = new INIKER.ATFunciones.AT_Funciones_WS();
        ...
        public ListaPaisesINDUSAL[] ReadMultiple(string Where, int pageSize, int numPage, string Sort)
        {
            bool flagResp = false;
            string lastReadKey = null;
            INIKER.Paises.ListaPaisesINDUSAL_Filter[] filtros = null;            
            //Array.Resize(ref misFiltros, 0);
            ListaPaisesINDUSAL[] consultaPage; // = new AT_Solicitudes();
        ...
        private bool AplicarFiltros(string Where, ref INIKER.Paises.ListaPaisesINDUSAL_Filter[] misFiltros)
        {
            ...
            try
            {
                INIKER.Paises.ListaPaisesINDUSAL_Filter miFiltro;
                Array.Resize(ref misFiltros, 0);
                ...
                if ((Where != null) && Where.Length > 0)
                {
                    ...
                    {
                        miFiltro = new INIKER.Paises.ListaPaisesINDUSAL_Filter();
                        miFiltro.Field = INIKER.Paises.ListaPaisesINDUSAL_Fields.Code;
                    ...
                    {
                        miFiltro = new INIKER.Paises.ListaPaisesINDUSAL_Filter();
                        miFiltro.Field = INIKER.Paises.ListaPaisesINDUSAL_Fields.Name;
                    ...
                    //    miFiltro.Field = INIKER.ATCliente.AT_Cliente_Fields.Address;
