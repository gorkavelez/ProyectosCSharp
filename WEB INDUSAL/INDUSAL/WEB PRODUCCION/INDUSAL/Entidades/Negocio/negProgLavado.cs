...
namespace INIKER.ProgLavado
{
    ...
    /// <remarks/>
    public partial class ListaPLavadoINDUSAL_Service : System.Web.Services.Protocols.SoapHttpClientProtocol
    {
        ...
        //List<AT_Solicitudes> ??
        [System.ComponentModel.Description("Devuelve una lista de Transportistas"), System.ComponentModel.DataObjectMethod(System.ComponentModel.DataObjectMethodType.Select, true)]
        public ListaPLavadoINDUSAL[] ReadMultiple(string Where, int pageSize, int numPage, string Sort)
        {
            bool flagResp = false;
            string lastReadKey = null;
            INIKER.ProgLavado.ListaPLavadoINDUSAL_Filter[] filtros = null;            
            //Array.Resize(ref misFiltros, 0);
            ListaPLavadoINDUSAL[] consultaPage; // = new AT_Solicitudes();
        ...
        private bool AplicarFiltros(string Where, ref INIKER.ProgLavado.ListaPLavadoINDUSAL_Filter[] misFiltros)
        {
            ...
            try
            {
                INIKER.ProgLavado.ListaPLavadoINDUSAL_Filter miFiltro;
                Array.Resize(ref misFiltros, 0);
                ...
                if ((Where != null) && Where.Length > 0)
                {
                    ...
                    {
                        miFiltro = new INIKER.ProgLavado.ListaPLavadoINDUSAL_Filter();
                        miFiltro.Field = INIKER.ProgLavado.ListaPLavadoINDUSAL_Fields.Maquina;
                    ...
                    //{
                    //    miFiltro = new INIKER.Transportistas.ListaTransportistasINDUSAL_Filter();
                    //    miFiltro.Field = INIKER.Transportistas.ListaTransportistasINDUSAL_Fields.Name;
