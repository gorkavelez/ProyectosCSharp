...
namespace INIKER.IncidenciasTransporte
{
    ...
    public partial class ListaIncidTransport_Service : System.Web.Services.Protocols.SoapHttpClientProtocol
    {
        ...
        public ListaIncidTransport[] ReadMultiple(string Where, int pageSize, int numPage, string Sort)
        {
            bool flagResp = false;
            string lastReadKey = null;
            INIKER.IncidenciasTransporte.ListaIncidTransport_Filter[] filtros = null;            
            //Array.Resize(ref misFiltros, 0);
            ListaIncidTransport[] consultaPage; // = new AT_Solicitudes();
        ...
        private bool AplicarFiltros(string Where, ref INIKER.IncidenciasTransporte.ListaIncidTransport_Filter[] misFiltros)
        {
            ...
            try
            {
                INIKER.IncidenciasTransporte.ListaIncidTransport_Filter miFiltro;
                Array.Resize(ref misFiltros, 0);
                ...
                if ((Where != null) && Where.Length > 0)
                {
                    ...
                    //0: Interaction_Group_Code
                    if ((strFiltros[0] != null) && strFiltros[0] != string.Empty)
                    {
                        miFiltro = new INIKER.IncidenciasTransporte.ListaIncidTransport_Filter();
                        miFiltro.Field = INIKER.IncidenciasTransporte.ListaIncidTransport_Fields.Interaction_Group_Code;
