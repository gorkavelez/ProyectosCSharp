...
namespace INIKER.NumerosSerie
{
    ...
    public partial class InformacionNumSerie_Service : System.Web.Services.Protocols.SoapHttpClientProtocol
    {
        ...
        public InformacionNumSerie[] ReadMultiple(string Where, int pageSize, int numPage, string Sort)
        {
            bool flagResp = false;
            string lastReadKey = null;
            INIKER.NumerosSerie.InformacionNumSerie_Filter[] filtros = null;            
            //Array.Resize(ref misFiltros, 0);
            InformacionNumSerie[] consultaPage; // = new AT_Solicitudes();
        ...
        private bool AplicarFiltros(string Where, ref INIKER.NumerosSerie.InformacionNumSerie_Filter[] misFiltros)
        {
            ...
            try
            {
                INIKER.NumerosSerie.InformacionNumSerie_Filter miFiltro;
                Array.Resize(ref misFiltros, 0);
                ...
                if ((Where != null) && Where.Length > 0)
                {
                    ...
                    if ((strFiltros[0] != null) && strFiltros[0] != string.Empty)
                    {
                        ...
                        miFiltro.Field = INIKER.NumerosSerie.InformacionNumSerie_Fields.Cod_Cliente;
