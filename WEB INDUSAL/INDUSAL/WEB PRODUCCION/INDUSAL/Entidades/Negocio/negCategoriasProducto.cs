...
namespace INIKER.CategoriasProducto
{
    ...
    public partial class ListaCategoriasProductoINDUSAL_Service : System.Web.Services.Protocols.SoapHttpClientProtocol
    {
        ...
        public ListaCategoriasProductoINDUSAL[] ReadMultiple(string Where, int pageSize, int numPage, string Sort)
        {
            bool flagResp = false;
            string lastReadKey = null;
            INIKER.CategoriasProducto.ListaCategoriasProductoINDUSAL_Filter[] filtros = null;            
            //Array.Resize(ref misFiltros, 0);
            ListaCategoriasProductoINDUSAL[] consultaPage; // = new AT_Solicitudes();
        ...
        private bool AplicarFiltros(string Where, ref INIKER.CategoriasProducto.ListaCategoriasProductoINDUSAL_Filter[] misFiltros)
        {
            ...
            try
            {
                INIKER.CategoriasProducto.ListaCategoriasProductoINDUSAL_Filter miFiltro;
                Array.Resize(ref misFiltros, 0);
                ...
                if ((Where != null) && Where.Length > 0)
                {
                    ...
                    if ((strFiltros[0] != null) && strFiltros[0] != string.Empty)
                    {
                        ...
                        miFiltro.Field = INIKER.CategoriasProducto.ListaCategoriasProductoINDUSAL_Fields.Code;
