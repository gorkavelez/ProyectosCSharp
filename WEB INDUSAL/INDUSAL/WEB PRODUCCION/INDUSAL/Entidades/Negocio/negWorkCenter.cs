...
namespace INIKER.WorkCenter
{
    ...
    public partial class WorkCenterList_Service : System.Web.Services.Protocols.SoapHttpClientProtocol
    {
        ...
        //List<AT_Solicitudes> ??
        [System.ComponentModel.Description("Devuelve listados de Lavadoras y Túneles de Lavado"), System.ComponentModel.DataObjectMethod(System.ComponentModel.DataObjectMethodType.Select, true)]
        public WorkCenterList[] ReadMultiple(string Where, int pageSize, int numPage, string Sort)
        {
            bool flagResp = false;
            string lastReadKey = null;
            INIKER.WorkCenter.WorkCenterList_Filter[] filtros = null;            
            //Array.Resize(ref misFiltros, 0);
            WorkCenterList[] consultaPage; // = new AT_Solicitudes();
        ...
        private bool AplicarFiltros(string Where, ref INIKER.WorkCenter.WorkCenterList_Filter[] misFiltros)
        {
            ...
            try
            {
                INIKER.WorkCenter.WorkCenterList_Filter miFiltro;
                Array.Resize(ref misFiltros, 0);
                ...
                if ((Where != null) && Where.Length > 0)
                {
                    ...
                    //0: Work_Center_Group_Code
                    if ((strFiltros[0] != null) && strFiltros[0] != string.Empty)
                    {
                        miFiltro = new INIKER.WorkCenter.WorkCenterList_Filter();
                        miFiltro.Field = INIKER.WorkCenter.WorkCenterList_Fields.Work_Center_Group_Code;
                    ...
                    //{
                    //    miFiltro = new INIKER.CategoriasProducto.ListaCategoriasProductoINDUSAL_Filter();
                    //    miFiltro.Field = INIKER.CategoriasProducto.ListaCategoriasProductoINDUSAL_Fields.Description;
