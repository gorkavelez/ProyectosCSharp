...
namespace INIKER.Cliente
{
    ...
    public partial class ListaClientesINDUSAL_Service : System.Web.Services.Protocols.SoapHttpClientProtocol
    {
        ...
        public ListaClientesINDUSAL[] ReadMultiple(string Where, int pageSize, int numPage, string Sort)
        {
            bool flagResp = false;
            string lastReadKey = null;
            INIKER.Cliente.ListaClientesINDUSAL_Filter[] filtros = null;            
            //Array.Resize(ref misFiltros, 0);
            ListaClientesINDUSAL[] consultaPage; // = new AT_Solicitudes();
        ...
        private bool AplicarFiltros(string Where, ref INIKER.Cliente.ListaClientesINDUSAL_Filter[] misFiltros)
        {
            ...
            try
            {
                INIKER.Cliente.ListaClientesINDUSAL_Filter miFiltro;
                Array.Resize(ref misFiltros, 0);
