...
namespace INIKER.Transportistas
{
    ...
    public partial class ListaTransportistasINDUSAL_Service : System.Web.Services.Protocols.SoapHttpClientProtocol
    {
        ...
        public ListaTransportistasINDUSAL[] ReadMultiple(string Where, int pageSize, int numPage, string Sort)
        {
            bool flagResp = false;
            string lastReadKey = null;
            INIKER.Transportistas.ListaTransportistasINDUSAL_Filter[] filtros = null;            
            //Array.Resize(ref misFiltros, 0);
            ListaTransportistasINDUSAL[] consultaPage; // = new AT_Solicitudes();
        ...
        private bool AplicarFiltros(string Where, ref INIKER.Transportistas.ListaTransportistasINDUSAL_Filter[] misFiltros)
        {
            ...
            try
            {
                INIKER.Transportistas.ListaTransportistasINDUSAL_Filter miFiltro;
                Array.Resize(ref misFiltros, 0);
                ...
                if ((Where != null) && Where.Length > 0)
                {
                    ...
                    if ((strFiltros[0] != null) && strFiltros[0] != string.Empty)
                    {
                        ...
                        miFiltro.Field = INIKER.Transportistas.ListaTransportistasINDUSAL_Fields.Code;
                    ...
                    //2: Empresa_transportista
                    if (strFiltros.Length > 2 && (strFiltros[2] != null) && strFiltros[2] != string.Empty)
                    {
                        miFiltro = new INIKER.Transportistas.ListaTransportistasINDUSAL_Filter();
                        miFiltro.Field = INIKER.Transportistas.ListaTransportistasINDUSAL_Fields.Empresa_transportista;
