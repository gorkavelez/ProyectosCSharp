...
namespace INIKER.Item
{
    ...
    public partial class ItemList_Service : System.Web.Services.Protocols.SoapHttpClientProtocol
    {
        ...
        public ItemList[] ReadMultiple(string Where, int pageSize, int numPage, string Sort)
        {
            bool flagResp = false;
            string lastReadKey = null;
            INIKER.Item.ItemList_Filter[] filtros = null;            
            //Array.Resize(ref misFiltros, 0);
            ItemList[] consultaPage; // = new AT_Solicitudes();
        ...
        private bool AplicarFiltros(string Where, ref INIKER.Item.ItemList_Filter[] misFiltros)
        {
            ...
            try
            {
                INIKER.Item.ItemList_Filter miFiltro;
                Array.Resize(ref misFiltros, 0);
                ...
                if ((Where != null) && Where.Length > 0)
                {
                    ...
                    if ((strFiltros[0] != null) && strFiltros[0] != string.Empty)
                    {
                        ...
                        miFiltro.Field = INIKER.Item.ItemList_Fields.No;
                    ...
                    //2: Product_Group_Code
                    if (strFiltros.Length > 2 && (strFiltros[2] != null) && strFiltros[2] != string.Empty)
                    {
                        miFiltro = new INIKER.Item.ItemList_Filter();
                        miFiltro.Field = INIKER.Item.ItemList_Fields.Product_Group_Code;
