...
namespace INIKER.LineasVenta
{
    ...
    public partial class ListaLineasVentaINDUSAL_Service : System.Web.Services.Protocols.SoapHttpClientProtocol
    {
        ...
        public ListaLineasVentaINDUSAL[] ReadMultiple(string Where, int pageSize, int numPage, string Sort)
        {
            bool flagResp = false;
            string lastReadKey = null;
            INIKER.LineasVenta.ListaLineasVentaINDUSAL_Filter[] filtros = null;            
            //Array.Resize(ref misFiltros, 0);
            ListaLineasVentaINDUSAL[] consultaPage; // = new AT_Solicitudes();
        ...
        private bool AplicarFiltros(string Where, ref INIKER.LineasVenta.ListaLineasVentaINDUSAL_Filter[] misFiltros)
        {
            ...
            try
            {
                INIKER.LineasVenta.ListaLineasVentaINDUSAL_Filter miFiltro;
                Array.Resize(ref misFiltros, 0);
                ...
                if ((Where != null) && Where.Length > 0)
                {
                    ...
                    {
                        miFiltro = new INIKER.LineasVenta.ListaLineasVentaINDUSAL_Filter();
                        miFiltro.Field = INIKER.LineasVenta.ListaLineasVentaINDUSAL_Fields.Document_Type;
                    ...
                    {
                        miFiltro = new INIKER.LineasVenta.ListaLineasVentaINDUSAL_Filter();
                        miFiltro.Field = INIKER.LineasVenta.ListaLineasVentaINDUSAL_Fields.Document_No;
                    ...
                    {
                        miFiltro = new INIKER.LineasVenta.ListaLineasVentaINDUSAL_Filter();
                        miFiltro.Field = INIKER.LineasVenta.ListaLineasVentaINDUSAL_Fields.Sell_to_Customer_No;
