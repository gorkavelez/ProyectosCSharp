...
namespace INIKER.WorkShift
{
    ...
    public partial class WorkShiftList_Service : System.Web.Services.Protocols.SoapHttpClientProtocol
    {
        ...
        public WorkShiftList[] ReadMultiple(string Where, int pageSize, int numPage, string Sort)
        {
            bool flagResp = false;
            string lastReadKey = null;
            INIKER.WorkShift.WorkShiftList_Filter[] filtros = null;            
            //Array.Resize(ref misFiltros, 0);
            WorkShiftList[] consultaPage; // = new AT_Solicitudes();
        ...
        private bool AplicarFiltros(string Where, ref INIKER.WorkShift.WorkShiftList_Filter[] misFiltros)
        {
            ...
            try
            {
                INIKER.WorkShift.WorkShiftList_Filter miFiltro;
                Array.Resize(ref misFiltros, 0);
                ...
                if ((Where != null) && Where.Length > 0)
                {
                    ...
                    {
                        miFiltro = new INIKER.WorkShift.WorkShiftList_Filter();
                        miFiltro.Field = INIKER.WorkShift.WorkShiftList_Fields.Code;
