...
namespace INIKER.RutasTransporte
{
    ...
    public partial class ListaRTransporteINDUSAL_Service : System.Web.Services.Protocols.SoapHttpClientProtocol
    {
        ...
        public ListaRTransporteINDUSAL[] ReadMultiple(string Where, int pageSize, int numPage, string Sort)
        {
            bool flagResp = false;
            string lastReadKey = null;
            INIKER.RutasTransporte.ListaRTransporteINDUSAL_Filter[] filtros = null;            
            //Array.Resize(ref misFiltros, 0);
            ListaRTransporteINDUSAL[] consultaPage; // = new AT_Solicitudes();
        ...
        private bool AplicarFiltros(string Where, ref INIKER.RutasTransporte.ListaRTransporteINDUSAL_Filter[] misFiltros)
        {
            ...
            try
            {
                INIKER.RutasTransporte.ListaRTransporteINDUSAL_Filter miFiltro;
                Array.Resize(ref misFiltros, 0);
                ...
                if ((Where != null) && Where.Length > 0)
                {
                    ...
                    if ((strFiltros[0] != null) && strFiltros[0] != string.Empty)
                    {
                        ...
                        miFiltro.Field = INIKER.RutasTransporte.ListaRTransporteINDUSAL_Fields.Codigo;
                    ...
                    //{
                    //    miFiltro = new INIKER.RutasTransporte.ListaRTransporteINDUSAL_Filter();
                    //    miFiltro.Field = INIKER.RutasTransporte.ListaRTransporteINDUSAL_Fields.Cod_transportista;
