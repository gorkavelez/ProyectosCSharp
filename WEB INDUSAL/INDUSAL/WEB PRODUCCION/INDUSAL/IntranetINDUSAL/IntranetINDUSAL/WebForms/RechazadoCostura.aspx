<%@ Page Title="" Language="C#" MasterPageFile="~/MasterForms/menu.Master" AutoEventWireup="true" CodeBehind="RechazadoCostura.aspx.cs" Inherits="IntranetINDUSAL.WebForms.RechazadoCostura" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <tr>
        ...
        <td style="height: 83px; width: 669px;">
            <asp:Button ID="btProduccion" runat="server" Font-Bold="True" Font-Names="Calibri" 
                Height="70px" Text="A PRODUCCION" Width="110px" />
            &nbsp;&nbsp;
            <asp:Button ID="btTrapos" runat="server" Font-Bold="True" Font-Names="Calibri" 
                Height="70px" Text="A TRAPOS" Width="110px" />
            &nbsp;&nbsp;
