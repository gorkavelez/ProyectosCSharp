...
{
    public partial class DesaprestadoRopa2 : System.Web.UI.Page
    {
        ...
        #region SURTIDO
            ...
            protected void MostrarSurtidoClienteSAL(string cliente)
            {
                ...
                if (oSurtidoSAL == null)
                    oSurtidoSAL = new cSurtidoSAL(cliente, Session["empresaLogin"].ToString());
        ...
        {
            oConteo = null;
            oConteo = new cConteo(Session["empresaLogin"].ToString());            
