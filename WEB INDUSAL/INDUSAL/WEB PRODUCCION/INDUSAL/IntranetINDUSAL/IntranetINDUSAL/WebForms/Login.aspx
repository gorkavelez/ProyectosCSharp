<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="IntranetINDUSAL.WebForms.Login" %>
                ...
                <td>
                    <table style="width: 100%;">
                        <tr>
                            ...
                            <td>
                                <asp:TextBox ID="txUserName" runat="server" Width="125px"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            <td class="style1">
