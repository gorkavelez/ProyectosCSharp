...
namespace INIKER.PurchaseArchiveComments
{
    ...
    public partial class PurchaseArchiveComment_Service : System.Web.Services.Protocols.SoapHttpClientProtocol
    {
        ...
        public PurchaseArchiveComment[] ReadMultiple(string Where, int pageSize, int numPage, string Sort)
        {
            bool flagResp = false;
            string lastReadKey = null;
            INIKER.PurchaseArchiveComments.PurchaseArchiveComment_Filter[] filtros = null;
            //Array.Resize(ref misFiltros, 0);
            PurchaseArchiveComment[] consultaPage; // = new AT_Solicitudes();
        ...
        private bool AplicarFiltros(string Where, ref INIKER.PurchaseArchiveComments.PurchaseArchiveComment_Filter[] misFiltros)
        {
            ...
            try
            {
                INIKER.PurchaseArchiveComments.PurchaseArchiveComment_Filter miFiltro;
                Array.Resize(ref misFiltros, 0);
                ...
                if ((Where != null) && Where.Length > 0)
                {
                    ...
                    {
                        miFiltro = new INIKER.PurchaseArchiveComments.PurchaseArchiveComment_Filter();
                        miFiltro.Field = INIKER.PurchaseArchiveComments.PurchaseArchiveComment_Fields.No;
                    ...
                    {
                        miFiltro = new INIKER.PurchaseArchiveComments.PurchaseArchiveComment_Filter();
                        miFiltro.Field = INIKER.PurchaseArchiveComments.PurchaseArchiveComment_Fields.Version_No;
