...
namespace INIKER.PurchaseQuoteArchives
{
    ...
    public partial class PurchQuoteArchiveHeader_Service : System.Web.Services.Protocols.SoapHttpClientProtocol
    {
        ...
        public PurchQuoteArchiveHeader[] ReadMultiple(string Where, int pageSize, int numPage, string Sort)
        {
            bool flagResp = false;
            string lastReadKey = null;
            INIKER.PurchaseQuoteArchives.PurchQuoteArchiveHeader_Filter[] filtros = null;
            //Array.Resize(ref misFiltros, 0);
            PurchQuoteArchiveHeader[] consultaPage; // = new AT_Solicitudes();
        ...
        private bool AplicarFiltros(string Where, ref INIKER.PurchaseQuoteArchives.PurchQuoteArchiveHeader_Filter[] misFiltros)
        {
            ...
            try
            {
                INIKER.PurchaseQuoteArchives.PurchQuoteArchiveHeader_Filter miFiltro;
                Array.Resize(ref misFiltros, 0);
                ...
                if ((Where != null) && Where.Length > 0)
                {
                    ...
                    {
                        miFiltro = new INIKER.PurchaseQuoteArchives.PurchQuoteArchiveHeader_Filter();
                        miFiltro.Field = INIKER.PurchaseQuoteArchives.PurchQuoteArchiveHeader_Fields.No;
                    ...
                    {
                        miFiltro = new INIKER.PurchaseQuoteArchives.PurchQuoteArchiveHeader_Filter();
                        miFiltro.Field = INIKER.PurchaseQuoteArchives.PurchQuoteArchiveHeader_Fields.Version_No;
