...
namespace INIKER.PaymentMethods
{
    ...
    public partial class PaymentMethods_Service : System.Web.Services.Protocols.SoapHttpClientProtocol
    {
        ...
        public PaymentMethods[] ReadMultiple(string Where, int pageSize, int numPage, string Sort)
        {
            bool flagResp = false;
            string lastReadKey = null;
            INIKER.PaymentMethods.PaymentMethods_Filter[] filtros = null;
            //Array.Resize(ref misFiltros, 0);
            PaymentMethods[] consultaPage; // = new AT_Solicitudes();
        ...
        private bool AplicarFiltros(string Where, ref INIKER.PaymentMethods.PaymentMethods_Filter[] misFiltros)
        {
            ...
            try
            {
                INIKER.PaymentMethods.PaymentMethods_Filter miFiltro;
                Array.Resize(ref misFiltros, 0);
                ...
                if ((Where != null) && Where.Length > 0)
                {
                    ...
                    {
                        miFiltro = new INIKER.PaymentMethods.PaymentMethods_Filter();
                        miFiltro.Field = INIKER.PaymentMethods.PaymentMethods_Fields.Code;
