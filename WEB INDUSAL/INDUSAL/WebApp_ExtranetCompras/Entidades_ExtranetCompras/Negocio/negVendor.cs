...
namespace INIKER.Vendor
{
    ...
    public partial class VendorList_Service : System.Web.Services.Protocols.SoapHttpClientProtocol
    {
        ...
        public VendorList[] ReadMultiple(string Where, int pageSize, int numPage, string Sort)
        {
            bool flagResp = false;
            string lastReadKey = null;
            INIKER.Vendor.VendorList_Filter[] filtros = null;            
            //Array.Resize(ref misFiltros, 0);
            VendorList[] consultaPage; // = new AT_Solicitudes();
        ...
        private bool AplicarFiltros(string Where, ref INIKER.Vendor.VendorList_Filter[] misFiltros)
        {
            ...
            try
            {
                INIKER.Vendor.VendorList_Filter miFiltro;
                Array.Resize(ref misFiltros, 0);
                ...
                if ((Where != null) && Where.Length > 0)
                {
                    ...
                    {
                        miFiltro = new INIKER.Vendor.VendorList_Filter();
                        miFiltro.Field = INIKER.Vendor.VendorList_Fields.No;
                    ...
                    {
                        miFiltro = new INIKER.Vendor.VendorList_Filter();
                        miFiltro.Field = INIKER.Vendor.VendorList_Fields.Password_extranet;
