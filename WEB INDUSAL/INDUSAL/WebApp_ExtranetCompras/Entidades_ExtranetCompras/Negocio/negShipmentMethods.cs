...
namespace INIKER.ShipmentMethods
{
    ...
    public partial class ShipmentMethods_Service : System.Web.Services.Protocols.SoapHttpClientProtocol
    {
        ...
        public ShipmentMethods[] ReadMultiple(string Where, int pageSize, int numPage, string Sort)
        {
            bool flagResp = false;
            string lastReadKey = null;
            INIKER.ShipmentMethods.ShipmentMethods_Filter[] filtros = null;
            //Array.Resize(ref misFiltros, 0);
            ShipmentMethods[] consultaPage; // = new AT_Solicitudes();
        ...
        private bool AplicarFiltros(string Where, ref INIKER.ShipmentMethods.ShipmentMethods_Filter[] misFiltros)
        {
            ...
            try
            {
                INIKER.ShipmentMethods.ShipmentMethods_Filter miFiltro;
                Array.Resize(ref misFiltros, 0);
                ...
                if ((Where != null) && Where.Length > 0)
                {
                    ...
                    {
                        miFiltro = new INIKER.ShipmentMethods.ShipmentMethods_Filter();
                        miFiltro.Field = INIKER.ShipmentMethods.ShipmentMethods_Fields.Code;
