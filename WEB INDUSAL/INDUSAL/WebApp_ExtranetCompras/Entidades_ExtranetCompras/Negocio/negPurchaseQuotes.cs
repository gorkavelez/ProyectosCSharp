...
namespace INIKER.PurchaseQuotes
{
    ...
    public partial class PurchaseQuotes_Service : System.Web.Services.Protocols.SoapHttpClientProtocol
    {
        ...
        public PurchaseQuotes[] ReadMultiple(string Where, int pageSize, int numPage, string Sort)
        {
            bool flagResp = false;
            string lastReadKey = null;
            INIKER.PurchaseQuotes.PurchaseQuotes_Filter[] filtros = null;
            //Array.Resize(ref misFiltros, 0);
            PurchaseQuotes[] consultaPage; // = new AT_Solicitudes();
        ...
        private bool AplicarFiltros(string Where, ref INIKER.PurchaseQuotes.PurchaseQuotes_Filter[] misFiltros)
        {
            ...
            try
            {
                INIKER.PurchaseQuotes.PurchaseQuotes_Filter miFiltro;
                Array.Resize(ref misFiltros, 0);
                ...
                if ((Where != null) && Where.Length > 0)
                {
                    ...
                    //0: Buy_from_Vendor_No
                    if ((strFiltros[0] != null) && strFiltros[0] != string.Empty)
                    {
                        miFiltro = new INIKER.PurchaseQuotes.PurchaseQuotes_Filter();
                        miFiltro.Field = INIKER.PurchaseQuotes.PurchaseQuotes_Fields.Buy_from_Vendor_No;
