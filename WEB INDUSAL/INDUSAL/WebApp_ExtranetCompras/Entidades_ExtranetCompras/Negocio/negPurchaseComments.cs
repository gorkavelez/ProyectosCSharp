...
namespace INIKER.PurchaseComment
{
    ...
    public partial class PurchaseComment_Service : System.Web.Services.Protocols.SoapHttpClientProtocol
    {
        ...
        public PurchaseComment[] ReadMultiple(string Where, int pageSize, int numPage, string Sort)
        {
            bool flagResp = false;
            string lastReadKey = null;
            INIKER.PurchaseComment.PurchaseComment_Filter[] filtros = null;
            //Array.Resize(ref misFiltros, 0);
            PurchaseComment[] consultaPage; // = new AT_Solicitudes();
        ...
        private bool AplicarFiltros(string Where, ref INIKER.PurchaseComment.PurchaseComment_Filter[] misFiltros)
        {
            ...
            try
            {
                INIKER.PurchaseComment.PurchaseComment_Filter miFiltro;
                Array.Resize(ref misFiltros, 0);
                ...
                if ((Where != null) && Where.Length > 0)
                {
                    ...
                    {
                        miFiltro = new INIKER.PurchaseComment.PurchaseComment_Filter();
                        miFiltro.Field = INIKER.PurchaseComment.PurchaseComment_Fields.No;
