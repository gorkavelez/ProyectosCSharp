...
namespace INIKER.PurchaseQuoteArchiveLines
{
    ...
    public partial class PurchQuoteArchiveLines_Service : System.Web.Services.Protocols.SoapHttpClientProtocol
    {
        ...
        public PurchQuoteArchiveLines[] ReadMultiple(string Where, int pageSize, int numPage, string Sort)
        {
            bool flagResp = false;
            string lastReadKey = null;
            INIKER.PurchaseQuoteArchiveLines.PurchQuoteArchiveLines_Filter[] filtros = null;
            //Array.Resize(ref misFiltros, 0);
            PurchQuoteArchiveLines[] consultaPage; // = new AT_Solicitudes();
        ...
        private bool AplicarFiltros(string Where, ref INIKER.PurchaseQuoteArchiveLines.PurchQuoteArchiveLines_Filter[] misFiltros)
        {
            ...
            try
            {
                INIKER.PurchaseQuoteArchiveLines.PurchQuoteArchiveLines_Filter miFiltro;
                Array.Resize(ref misFiltros, 0);
                ...
                if ((Where != null) && Where.Length > 0)
                {
                    ...
                    {
                        miFiltro = new INIKER.PurchaseQuoteArchiveLines.PurchQuoteArchiveLines_Filter();
                        miFiltro.Field = INIKER.PurchaseQuoteArchiveLines.PurchQuoteArchiveLines_Fields.Document_No;
                    ...
                    {
                        miFiltro = new INIKER.PurchaseQuoteArchiveLines.PurchQuoteArchiveLines_Filter();
                        miFiltro.Field = INIKER.PurchaseQuoteArchiveLines.PurchQuoteArchiveLines_Fields.Version_No;
                    ...
                    //{
                    //    miFiltro = new INIKER.Cliente.ListaClientesINDUSAL_Filter();
                    //    miFiltro.Field = INIKER.Cliente.ListaClientesINDUSAL_Fields.Pedido_en_curso;
                    ...
                    //{
                    //    miFiltro = new INIKER.Cliente.ListaClientesINDUSAL_Filter();
                    //    miFiltro.Field = INIKER.Cliente.ListaClientesINDUSAL_Fields
