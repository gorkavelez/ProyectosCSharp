...
namespace INIKER.Cliente
{
    ...
    /// <remarks/>
    public partial class ClientesSubcontratados_Service : System.Web.Services.Protocols.SoapHttpClientProtocol
    {
        ...
        public ClientesSubcontratados[] ReadMultiple(string Where, int pageSize, int numPage, string Sort)
        {
            bool flagResp = false;
            string lastReadKey = null;
            INIKER.Cliente.ClientesSubcontratados_Filter[] filtros = null;            
            //Array.Resize(ref misFiltros, 0);
            ClientesSubcontratados[] consultaPage; // = new AT_Solicitudes();
        ...
        private bool AplicarFiltros(string Where, ref INIKER.Cliente.ClientesSubcontratados_Filter[] misFiltros)
        {
            ...
            try
            {
                INIKER.Cliente.ClientesSubcontratados_Filter miFiltro;
                Array.Resize(ref misFiltros, 0);
                ...
                if ((Where != null) && Where.Length > 0)
                {
                    ...
                    //0: Proveedor_subcontratacion
                    if ((strFiltros[0] != null) && strFiltros[0] != string.Empty)
                    {
                        miFiltro = new INIKER.Cliente.ClientesSubcontratados_Filter();
                        miFiltro.Field = INIKER.Cliente.ClientesSubcontratados_Fields.Proveedor_subcontratacion;
                    ...
                    //    miFiltro.Field = INIKER.Cliente.ListaClientesINDUSAL_Fields.No;
