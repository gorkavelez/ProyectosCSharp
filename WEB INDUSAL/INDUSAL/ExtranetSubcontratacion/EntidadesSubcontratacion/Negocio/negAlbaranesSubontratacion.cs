...
namespace INIKER.Albaran
{
    ...
    public partial class AlbaranesSubcontratacion_Service : System.Web.Services.Protocols.SoapHttpClientProtocol
    {
        ...
        public AlbaranesSubcontratacion[] ReadMultiple(string Where, int pageSize, int numPage, string Sort)
        {
            bool flagResp = false;
            string lastReadKey = null;
            INIKER.Albaran.AlbaranesSubcontratacion_Filter[] filtros = null;            
            //Array.Resize(ref misFiltros, 0);
            AlbaranesSubcontratacion[] consultaPage; // = new AT_Solicitudes();
        ...
        private bool AplicarFiltros(string Where, ref INIKER.Albaran.AlbaranesSubcontratacion_Filter[] misFiltros)
        {
            ...
            try
            {
                INIKER.Albaran.AlbaranesSubcontratacion_Filter miFiltro;
                Array.Resize(ref misFiltros, 0);
                ...
                if ((Where != null) && Where.Length > 0)
                {
                    ...
                    {
                        miFiltro = new INIKER.Albaran.AlbaranesSubcontratacion_Filter();
                        miFiltro.Field = INIKER.Albaran.AlbaranesSubcontratacion_Fields.Sell_to_Customer_No;
                    ...
                    {
                        miFiltro = new INIKER.Albaran.AlbaranesSubcontratacion_Filter();
                        miFiltro.Field = INIKER.Albaran.AlbaranesSubcontratacion_Fields.No;
