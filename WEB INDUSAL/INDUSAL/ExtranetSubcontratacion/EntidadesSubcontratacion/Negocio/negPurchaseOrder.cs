...
namespace INIKER.PurchaseOrder
{
    ...
    public partial class PurchaseOrder_Service : System.Web.Services.Protocols.SoapHttpClientProtocol
    {
        ...
        public PurchaseOrder[] ReadMultiple(string Where, int pageSize, int numPage, string Sort)
        {
            bool flagResp = false;
            string lastReadKey = null;
            INIKER.PurchaseOrder.PurchaseOrder_Filter[] filtros = null;            
            //Array.Resize(ref misFiltros, 0);
            PurchaseOrder[] consultaPage; // = new AT_Solicitudes();
        ...
        private bool AplicarFiltros(string Where, ref INIKER.PurchaseOrder.PurchaseOrder_Filter[] misFiltros)
        {
            ...
            try
            {
                INIKER.PurchaseOrder.PurchaseOrder_Filter miFiltro;
                Array.Resize(ref misFiltros, 0);
                ...
                if ((Where != null) && Where.Length > 0)
                {
                    ...
                    {
                        miFiltro = new INIKER.PurchaseOrder.PurchaseOrder_Filter();
                        miFiltro.Field = INIKER.PurchaseOrder.PurchaseOrder_Fields.Buy_from_Vendor_No;
                    ...
                    {
                        miFiltro = new INIKER.PurchaseOrder.PurchaseOrder_Filter();
                        miFiltro.Field = INIKER.PurchaseOrder.PurchaseOrder_Fields.Cliente_final_subcontr;
