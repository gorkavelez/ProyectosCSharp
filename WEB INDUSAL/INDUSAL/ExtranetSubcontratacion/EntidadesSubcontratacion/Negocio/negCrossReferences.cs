...
namespace INIKER.CrossReferences
{
    ...
    public partial class CrossReferencesINDUSAL_Service : System.Web.Services.Protocols.SoapHttpClientProtocol
    {
        ...
        public CrossReferencesINDUSAL[] ReadMultiple(string Where, int pageSize, int numPage, string Sort)
        {
            bool flagResp = false;
            string lastReadKey = null;
            INIKER.CrossReferences.CrossReferencesINDUSAL_Filter[] filtros = null;            
            //Array.Resize(ref misFiltros, 0);
            CrossReferencesINDUSAL[] consultaPage; // = new AT_Solicitudes();
        ...
        private bool AplicarFiltros(string Where, ref INIKER.CrossReferences.CrossReferencesINDUSAL_Filter[] misFiltros)
        {
            ...
            try
            {
                INIKER.CrossReferences.CrossReferencesINDUSAL_Filter miFiltro;
                Array.Resize(ref misFiltros, 0);
                ...
                if ((Where != null) && Where.Length > 0)
                {
                    ...
                    {
                        miFiltro = new INIKER.CrossReferences.CrossReferencesINDUSAL_Filter();
                        miFiltro.Field = INIKER.CrossReferences.CrossReferencesINDUSAL_Fields.Cross_Reference_Type_No;
                    ...
                    {
                        miFiltro = new INIKER.CrossReferences.CrossReferencesINDUSAL_Filter();
                        miFiltro.Field = INIKER.CrossReferences.CrossReferencesINDUSAL_Fields.Tipo_Planchado;
