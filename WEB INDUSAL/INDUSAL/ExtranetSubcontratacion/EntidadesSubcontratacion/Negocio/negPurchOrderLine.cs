...
namespace INIKER.PurchOrderLine
{
    using System;
    ...
    /// <remarks/>
    public partial class PurchOrderLine_Service : System.Web.Services.Protocols.SoapHttpClientProtocol
    {
        ...
        public PurchOrderLine[] ReadMultiple(string Where, int pageSize, int numPage, string Sort)
        {
            bool flagResp = false;
            string lastReadKey = null;
            INIKER.PurchOrderLine.PurchOrderLine_Filter[] filtros = null;            
            //Array.Resize(ref misFiltros, 0);
            PurchOrderLine[] consultaPage; // = new AT_Solicitudes();
        ...
        private bool AplicarFiltros(string Where, ref INIKER.PurchOrderLine.PurchOrderLine_Filter[] misFiltros)
        {
            ...
            try
            {
                INIKER.PurchOrderLine.PurchOrderLine_Filter miFiltro;
                Array.Resize(ref misFiltros, 0);
                ...
                if ((Where != null) && Where.Length > 0)
                {
                    ...
                    {
                        miFiltro = new INIKER.PurchOrderLine.PurchOrderLine_Filter();
                        miFiltro.Field = INIKER.PurchOrderLine.PurchOrderLine_Fields.Document_No;
