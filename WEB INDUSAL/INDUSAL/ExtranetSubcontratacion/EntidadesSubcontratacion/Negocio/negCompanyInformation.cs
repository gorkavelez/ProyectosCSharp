...
namespace INIKER.CompanyInformation
{
    ...
    public partial class CompanyInformation_Service : System.Web.Services.Protocols.SoapHttpClientProtocol
    {
        ...
        public CompanyInformation[] ReadMultiple(string Where, int pageSize, int numPage, string Sort)
        {
            bool flagResp = false;
            string lastReadKey = null;
            INIKER.CompanyInformation.CompanyInformation_Filter[] filtros = null;            
            //Array.Resize(ref misFiltros, 0);
            CompanyInformation[] consultaPage; // = new AT_Solicitudes();
        ...
        private bool AplicarFiltros(string Where, ref INIKER.CompanyInformation.CompanyInformation_Filter[] misFiltros)
        {
            ...
            try
            {
                INIKER.CompanyInformation.CompanyInformation_Filter miFiltro;
                Array.Resize(ref misFiltros, 0);
                ...
                if ((Where != null) && Where.Length > 0)
                {
                    ...
                    {
                        miFiltro = new INIKER.CompanyInformation.CompanyInformation_Filter();
                        miFiltro.Field = INIKER.CompanyInformation.CompanyInformation_Fields.Abbreviated_Name;
