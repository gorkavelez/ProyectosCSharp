...
namespace INIKER.Surtido
{
    ...
    /// <remarks/>
    public partial class SurtidosCompletos_Service : System.Web.Services.Protocols.SoapHttpClientProtocol
    {
        ...
        public SurtidosCompletos[] ReadMultiple(string Where, int pageSize, int numPage, string Sort)
        {
            bool flagResp = false;
            string lastReadKey = null;
            INIKER.Surtido.SurtidosCompletos_Filter[] filtros = null;            
            //Array.Resize(ref misFiltros, 0);
            SurtidosCompletos[] consultaPage; // = new AT_Solicitudes();
        ...
        private bool AplicarFiltros(string Where, ref INIKER.Surtido.SurtidosCompletos_Filter[] misFiltros)
        {
            ...
            try
            {
                INIKER.Surtido.SurtidosCompletos_Filter miFiltro;
                Array.Resize(ref misFiltros, 0);
                ...
                if ((Where != null) && Where.Length > 0)
                {
                    ...
                    {
                        miFiltro = new INIKER.Surtido.SurtidosCompletos_Filter();
                        miFiltro.Field = INIKER.Surtido.SurtidosCompletos_Fields.Cross_Reference_Type_No;
                    ...
                    {
                        miFiltro = new INIKER.Surtido.SurtidosCompletos_Filter();
                        miFiltro.Field = INIKER.Surtido.SurtidosCompletos_Fields.Tipo_Planchado;
