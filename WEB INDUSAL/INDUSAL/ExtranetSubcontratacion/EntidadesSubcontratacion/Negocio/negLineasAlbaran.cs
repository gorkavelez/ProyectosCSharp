...
namespace INIKER.LineasAlbaran
{
    using System;
    ...
    /// <remarks/>
    public partial class LineasAlbaranVenta_Service : System.Web.Services.Protocols.SoapHttpClientProtocol
    {
        ...
        public LineasAlbaranVenta[] ReadMultiple(string Where, int pageSize, int numPage, string Sort)
        {
            bool flagResp = false;
            string lastReadKey = null;
            INIKER.LineasAlbaran.LineasAlbaranVenta_Filter[] filtros = null;            
            //Array.Resize(ref misFiltros, 0);
            LineasAlbaranVenta[] consultaPage; // = new AT_Solicitudes();
        ...
        private bool AplicarFiltros(string Where, ref INIKER.LineasAlbaran.LineasAlbaranVenta_Filter[] misFiltros)
        {
            ...
            try
            {
                INIKER.LineasAlbaran.LineasAlbaranVenta_Filter miFiltro;
                Array.Resize(ref misFiltros, 0);
                ...
                if ((Where != null) && Where.Length > 0)
                {
                    ...
                    {
                        miFiltro = new INIKER.LineasAlbaran.LineasAlbaranVenta_Filter();
                        miFiltro.Field = INIKER.LineasAlbaran.LineasAlbaranVenta_Fields.Document_No;
