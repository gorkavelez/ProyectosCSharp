<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="ExtranetSubcontratacion._Default" %>
        ...
        <asp:Panel ID="panelLineasPedido" runat="server" Visible="false">        
            <table>
                <tr>
                    ...
                    <td>
                        <asp:LinkButton ID="btNuevaLinea" runat="server" onclick="btNuevaLinea_Click" CssClass="texto_link" Visible="false">Nueva línea</asp:LinkButton>
                    </td>
                    <td></td>
                    <td>
                        <asp:LinkButton ID="btSurtidoCte" runat="server" CssClass="texto_link" 
                            onclick="btSurtidoCte_Click">Surtido</asp:LinkButton>
                    </td>
                </tr>
            </table>
            <br />              
                    ...
                    <tr>
                        <td>
                            <telerik:RadComboBox ID="ddlFamilias" runat="server" AutoPostBack="True" 
                                onselectedindexchanged="ddlFamilias_SelectedIndexChanged" CssClass="desplegable">
                            </telerik:RadComboBox>                            
                        </td>                    
                        <td>
