...
namespace SK.SabanasGrupos
{
    ...
    public partial class CapturaDatos_AdquisicionSabanasGrupos_Service : System.Web.Services.Protocols.SoapHttpClientProtocol
    {
        ...
        public CapturaDatos_AdquisicionSabanasGrupos[] ReadMultiple(string Where, int pageSize, int numPage, string Sort)
        {
            ...
            SK.SabanasGrupos.CapturaDatos_AdquisicionSabanasGrupos_Filter[] filtros = null;
        ...
        private bool AplicarFiltros(string Where, ref SK.SabanasGrupos.CapturaDatos_AdquisicionSabanasGrupos_Filter[] misFiltros)
        {
            ...
            try
            {
                SK.SabanasGrupos.CapturaDatos_AdquisicionSabanasGrupos_Filter miFiltro;
                Array.Resize(ref misFiltros, 0);
                ...
                if ((Where != null) && Where.Length > 0)
                {
                    ...
                    {
                        miFiltro = new SK.SabanasGrupos.CapturaDatos_AdquisicionSabanasGrupos_Filter();
                        miFiltro.Field = SK.SabanasGrupos.CapturaDatos_AdquisicionSabanasGrupos_Fields.Grupo;
