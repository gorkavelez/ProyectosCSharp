...
namespace SK.AdquisicionConceptos
{
    ...
    public partial class CapturaDatos_AdquisicionConceptos_Service : System.Web.Services.Protocols.SoapHttpClientProtocol
    {
        ...
        public CapturaDatos_AdquisicionConceptos[] ReadMultiple(string Where, int pageSize, int numPage, string Sort)
        {
            ...
            SK.AdquisicionConceptos.CapturaDatos_AdquisicionConceptos_Filter[] filtros = null;
        ...
        private bool AplicarFiltros(string Where, ref SK.AdquisicionConceptos.CapturaDatos_AdquisicionConceptos_Filter[] misFiltros)            
        {
            ...
            try
            {
                SK.AdquisicionConceptos.CapturaDatos_AdquisicionConceptos_Filter miFiltro;
                ...
                if ((Where != null) && Where.Length > 0)
                {
                    ...
                    {
                        miFiltro = new SK.AdquisicionConceptos.CapturaDatos_AdquisicionConceptos_Filter();
                        miFiltro.Field = SK.AdquisicionConceptos.CapturaDatos_AdquisicionConceptos_Fields.Codigo;
