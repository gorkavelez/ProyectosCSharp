...
namespace NegCapturaDatosWPF.historicoAdquisicionConceptos
{
    ...
    public partial class CapturaDatos_HistoricoAdquisicionConceptos_Service : System.Web.Services.Protocols.SoapHttpClientProtocol
    {
        ...
        public NegCapturaDatosWPF.historicoAdquisicionConceptos.CapturaDatos_HistoricoAdquisicionConceptos[] ReadMultiple(string Where, int pageSize, int numPage, string Sort)
        {
            bool flagResp = false;
            string lastReadKey = null;
            NegCapturaDatosWPF.historicoAdquisicionConceptos.CapturaDatos_HistoricoAdquisicionConceptos_Filter[] filtros = null;
            //Array.Resize(ref misFiltros, 0);
            NegCapturaDatosWPF.historicoAdquisicionConceptos.CapturaDatos_HistoricoAdquisicionConceptos[] consultaPage; // = new AT_Solicitudes();
        ...
        private bool AplicarFiltros(string Where, ref NegCapturaDatosWPF.historicoAdquisicionConceptos.CapturaDatos_HistoricoAdquisicionConceptos_Filter[] misFiltros)
        {
            ...
            try
            {
                NegCapturaDatosWPF.historicoAdquisicionConceptos.CapturaDatos_HistoricoAdquisicionConceptos_Filter miFiltro;
                Array.Resize(ref misFiltros, 0);
                ...
                if ((Where != null) && Where.Length > 0)
                {
                    ...
                    {
                        miFiltro = new NegCapturaDatosWPF.historicoAdquisicionConceptos.CapturaDatos_HistoricoAdquisicionConceptos_Filter();
                        miFiltro.Field = NegCapturaDatosWPF.historicoAdquisicionConceptos.CapturaDatos_HistoricoAdquisicionConceptos_Fields.Sabana;
                    ...
                    {
                        miFiltro = new NegCapturaDatosWPF.historicoAdquisicionConceptos.CapturaDatos_HistoricoAdquisicionConceptos_Filter();
                        miFiltro.Field = NegCapturaDatosWPF.historicoAdquisicionConceptos.CapturaDatos_HistoricoAdquisicionConceptos_Fields.Fecha_registro;
                    ...
                    {
                        miFiltro = new NegCapturaDatosWPF.historicoAdquisicionConceptos.CapturaDatos_HistoricoAdquisicionConceptos_Filter();
                        miFiltro.Field = NegCapturaDatosWPF.historicoAdquisicionConceptos.CapturaDatos_HistoricoAdquisicionConceptos_Fields.Hora_registro;
