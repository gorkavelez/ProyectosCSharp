            ...
            try
            {
                ...
                if ((Where != null) && Where.Length > 0)
                {
                    ...
                    if ((strFiltros[0] != null) && strFiltros[0] != string.Empty)
                    {
                        ...
                        miFiltro.Field = SK.Observaciones.CapturaDatos_Observaciones_Fields.Sabana;
                    ...
                    //1: Fecha registro
                    if ((strFiltros[1] != null) && strFiltros[1] != string.Empty)
                    {
                        miFiltro = new SK.Observaciones.CapturaDatos_Observaciones_Filter();
                        miFiltro.Field = SK.Observaciones.CapturaDatos_Observaciones_Fields.Fecha_Registro;
                    ...
                    //2: Hora registro
                    if ((strFiltros[2] != null) && strFiltros[2] != string.Empty)
                    {
                        miFiltro = new SK.Observaciones.CapturaDatos_Observaciones_Filter();
                        miFiltro.Field = SK.Observaciones.CapturaDatos_Observaciones_Fields.Hora_Registro;
