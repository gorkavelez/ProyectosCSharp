...
namespace Avalara.AvaTax.RestClient
{
    ...
    public class TransactionBuilder
    {
        ...
        /// Set a specific transaction code
        /// </summary>
        /// <param name="date">The code to use for this transaction</param>
        /// <returns>The TransactionBuilder object</returns>
        ...
        /// <param name="quantity">Quantity of the item.</param>
        /// <param name="taxCode">Tax Code of the item. If left blank, the default item (P0000000) is assumed.</param>
        /// <param name="itemCode">Item Code of the item.</param>
        /// <returns></returns>
        public TransactionBuilder WithLine(decimal amount, decimal quantity = 1, string taxCode = null, string itemCode = null)
        {
            var l = new LineItemModel
            {
                number = _line_number.ToString(),
        ...
        /// <param name="itemCode">Item Code of the item.</param>
        /// <returns></returns>
        public TransactionBuilder WithLine(string line_number, decimal amount, decimal quantity = 1, string taxCode = null, string itemCode = null)
        {
            var l = new LineItemModel
            {
                number = line_number,
